...
$date = str_replace('/', '-', $_POST['dtnascimentofun']);
$newDate = date("Y-m-d", strtotime($date));

switch ($acao) {
    case 0:
        $sql = "INSERT INTO funcionarios (idfun, nomefun, cpffun, dtnascimentofun, generofun, enderecofun, numerofun, bairrofun, cidadefun, estadofun, telefonefun, emailfun, senhafun, nivelfun,ativo) VALUES ('0', '" . $_POST['nomefun'] . "', '" . $_POST['cpffun'] . "', '" . $newDate . "', '" . $_POST['generofun'] . "', '" . $_POST['enderecofun'] . "', '" . $_POST['numerofun'] . "', '" . $_POST['bairrofun'] . "', '" . $_POST['cidadefun'] . "', '" . $_POST['estadofun'] . "', '" . $_POST['telefonefun'] . "', '" . $_POST['emailfun'] . "', '" . $_POST['senhafun'] . "', '" . $_POST['nivelfun'] . "','1');";
