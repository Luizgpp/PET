...
$date = str_replace('/', '-', $_POST['dtnascimentocli']);
$newDate = date("Y-m-d", strtotime($date));

switch ($acao) {
    case 0:
        $sql = "INSERT INTO clientes (idcli, nomecli, cpfcli, dtnascimentocli, generocli, enderecocli, numerocli, bairrocli, cidadecli, estadocli, telefonecli, emailcli, senhacli, ativo) VALUES ('0', '" . $_POST['nomecli'] . "', '" . $_POST['cpfcli'] . "', '" . $newDate . "', '" . $_POST['generocli'] . "', '" . $_POST['enderecocli'] . "', '" . $_POST['numerocli'] . "', '" . $_POST['bairrocli'] . "', '" . $_POST['cidadecli'] . "', '" . $_POST['estadocli'] . "', '" . $_POST['telefonecli'] . "', '" . $_POST['emailcli'] . "', '" . $_POST['senhacli'] . "','1');";
